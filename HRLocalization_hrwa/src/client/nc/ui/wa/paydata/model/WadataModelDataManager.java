...
//		//按照字母大小排序
//		Arrays.sort(vos, new Comparator<WaPaydataDspVO>() {
//
//			@Override
//			public int compare(WaPaydataDspVO arg0, WaPaydataDspVO arg1) {
...
//		});
		...
		//Left 按照字母顺序排序 方便查询  右边按照已保存的顺序
		Collections.sort(dspLeftList, new Comparator<WaPaydataDspVO>(){

			@Override
			public int compare(WaPaydataDspVO o1, WaPaydataDspVO o2) {
