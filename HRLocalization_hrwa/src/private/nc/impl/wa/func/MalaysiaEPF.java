...
public class MalaysiaEPF extends AbstractPreExcutorFormulaParse {
	...
	private String getEmployeeContribution(String monthlySalary, String bonus, String epfGroup) {
		...
		sb.append(" case when " + monthlySalary + bonus + " > 20000 and sealocal_epf_rates.group_name = 'GROUP A' then (" + monthlySalary + bonus + ") * 0.11 ");
		// Group B, when monthly wage is over 20000, the employee contribution is wage * 11%
		sb.append(" when " + monthlySalary + bonus + " > 20000 and sealocal_epf_rates.group_name = 'GROUP B' then (" + monthlySalary + bonus + ") * 0.11 ");
		// Group C, when monthly wage is over 20000, the employee contribution is wage * 5.5%
		sb.append(" when " + monthlySalary + bonus + " > 20000 and sealocal_epf_rates.group_name = 'GROUP C' then (" + monthlySalary + bonus + ") * 0.055 ");
		// Group D, when monthly wage is over 20000, the employee contribution is wage * 5.5%
		sb.append(" when " + monthlySalary + bonus + " > 20000 and sealocal_epf_rates.group_name = 'GROUP D' then (" + monthlySalary + bonus + ") * 0.055 ");
		// Else, if wage is not over 20000, strictly follow the EPF table
		sb.append(" else employee_cont end employee_cont ");
		sb.append(" from sealocal_epf_rates where " + monthlySalary + bonus + " >= lower and " + monthlySalary + bonus + " <= upper ");
	...
	private String getEmployerContribution(String monthlySalary, String bonus, String epfGroup) {
		...
		sb.append(" case when " + monthlySalary + " <= 5000 and " + monthlySalary + bonus 
				+ " > 5000 and sealocal_epf_rates.group_name = 'GROUP A' then (" + monthlySalary + bonus + ") * 0.13 ");
		...
		sb.append(" when " + monthlySalary + " <= 5000 and " + monthlySalary + bonus 
				+ " > 5000 and sealocal_epf_rates.group_name = 'GROUP C' then (" + monthlySalary + bonus + ") * 0.065 ");
		// Group A, when monthly wage is over 20000, the employer contribution is wage * 12%
		sb.append(" when " + monthlySalary + bonus + " > 20000 and sealocal_epf_rates.group_name = 'GROUP A' then (" + monthlySalary + bonus + ") * 0.12 ");
		// Group B, when monthly wage is over 20000, the employer contribution is RM5.00
		sb.append(" when " + monthlySalary + bonus + " > 20000 and sealocal_epf_rates.group_name = 'GROUP B' then 5.00 ");
		// Group C, when monthly wage is over 20000, the employer contribution is wage * 6%
		sb.append(" when " + monthlySalary + bonus + " > 20000 and sealocal_epf_rates.group_name = 'GROUP C' then (" + monthlySalary + bonus + ") * 0.06 ");
		// Group D, when monthly wage is over 20000, the employer contribution is RM5.00
		sb.append(" when " + monthlySalary + bonus + " > 20000 and sealocal_epf_rates.group_name = 'GROUP D' then 5.00 ");
