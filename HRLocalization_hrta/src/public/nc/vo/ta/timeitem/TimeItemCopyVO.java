...
public abstract class TimeItemCopyVO extends SuperVO implements IBasedocCopyVO<TimeItemVO>{
	
	//年假、加班转调休、哺乳假、普通加班、公休加班、节日加班不可删除
	public static final String[] NOTDELETECODEARRAY_LEAVE = new String[]{"105","110","111"};
	public static final String[] NOTDELETECODEARRAY_OVERTIME = new String[]{"201","202","203"};
	...
	public static final String OVERTIMETOLEAVETYPE="110";//加班转调休编码
	...
	private UFBoolean isattachmust;
	...
	public static final String ISATTACHMUST = "isattachmust";
			
	/**
	 * 属性pk_timeitemcopy的Getter方法.
	 * 创建日期:2010-09-14 20:34:15
	...
	/**
	 * 属性pk_timeitemcopy的Setter方法.
	 * 创建日期:2010-09-14 20:34:15
	 * @param newPk_timeitemcopy java.lang.String
	 */
	...
	/**
	 * 属性timeitemunit的Setter方法.
	 * 创建日期:2010-09-14 20:34:15
	 * @param newTimeitemunit java.lang.Integer
	 */
	...
	public int getTimeItemUnit(){
		return timeitemunit==null?TIMEITEMUNIT_DAY:timeitemunit.intValue();
	}
	...
	/**
	 * 属性isleavelimit的Setter方法.
	 * 创建日期:2010-09-14 20:34:15
	 * @param newLeavelimit nc.vo.pub.lang.UFBoolean
	 */
	...
	/**
	 * 属性calculatetype的Setter方法.
	 * 创建日期:2010-09-14 20:34:15
	 * @param newCalculatetype java.lang.Integer
	 */
	 ...
	 * 属性timeunit的Setter方法.
	 * 创建日期:2010-09-14 20:34:15
	 * @param newTimeunit nc.vo.pub.lang.UFDouble
	 */
	...
	/**
	 * 属性convertrule的Setter方法.
	 * 创建日期:2010-09-14 20:34:15
	 * @param newConvertrule java.lang.Integer
	 */
	 ...
	 * 属性formula的Setter方法.
	 * 创建日期:2010-09-14 20:34:15
	 * @param newFormula java.lang.Object
	 */
	 ...
	 * 创建日期:2010-09-14 20:34:15
	 * @param newFormulastr java.lang.Object
	 */
	...
	public boolean isLeaveAppTimeLimit(){
		return isleaveapptimelimit!=null&&isleaveapptimelimit.booleanValue();
	}
	public nc.vo.pub.lang.UFBoolean getIsleaveapptimelimit() {
		return isleaveapptimelimit;
	}
	public void setIsleaveapptimelimit(nc.vo.pub.lang.UFBoolean isleaveapptimelimit) {
	...
	public String getMultilangName(){
		...
		case 1:
			return timeitemname;
		case 2:
			return StringUtils.isEmpty(timeitemname2)?timeitemname:timeitemname2;
		case 3:
			return StringUtils.isEmpty(timeitemname3)?timeitemname:timeitemname3;
		case 4:
			return StringUtils.isEmpty(timeitemname4)?timeitemname:timeitemname4;
		case 5:
			return StringUtils.isEmpty(timeitemname5)?timeitemname:timeitemname5;
		case 6:
			return StringUtils.isEmpty(timeitemname6)?timeitemname:timeitemname6;
		}
		return null;
    }
	@Override
	...
	// HR本地化：增加附件必须上传控制字段 start
	public UFBoolean getIsattachmust() {
		return isattachmust;
	}
	public void setIsattachmust(UFBoolean isattachmust) {
		this.isattachmust = isattachmust;
	}
	// HR本地化：增加附件必须上传控制字段 end
