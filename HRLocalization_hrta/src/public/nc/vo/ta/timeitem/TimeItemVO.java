...
public abstract class TimeItemVO extends SuperVO implements IBasedocDefVO{
	...
	private nc.vo.pub.lang.UFBoolean isattachmust;
	...
	// 本地化改动：增加附件必须上传字段 start
	public nc.vo.pub.lang.UFBoolean getIsattachmust() {
		return isattachmust;
	}
	public void setIsattachmust(nc.vo.pub.lang.UFBoolean isattachmust) {
		this.isattachmust = isattachmust;
	}
	// 本地化改动：增加附件必须上传字段 end	
