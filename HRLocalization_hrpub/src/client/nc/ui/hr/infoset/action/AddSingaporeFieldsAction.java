 ...
 * @author Ethan Wu
 ***************************************************************************/
public class AddSingaporeFieldsAction extends HrAction{

	private static final long serialVersionUID = -2861185272007518586L;

	public AddSingaporeFieldsAction() {
		super();
		
		//TODO: 尽快建立按钮名称和描述的多语字段
		this.setBtnName("Singapore");
	...
	public void doAction(ActionEvent e) throws Exception {
		NCLocator.getInstance().lookup(IInfoSet.class).addLocalizationFields("SG");
	}
